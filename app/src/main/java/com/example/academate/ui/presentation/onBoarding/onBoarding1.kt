...
private const val TAG = "OnBoarding1"
...
fun onBoarding1(navController: NavController) {
    ...
    Column (
        ...
        Text(
            text = "Aplikasi penyedia layanan penyewaan mentor segala jenis mata pelajaran",
            fontSize = 12.sp,
        ...
        Row(
            ...
            Row(
                ...
                ClickableText(
                    ...
                    modifier = Modifier
                        ...
                        .padding(8.dp),
                    onClick = {
                        Log.d(TAG, "Skip button clicked - Navigating to LOGIN")
                        navController.navigate(Route.LOGIN) {
                            popUpTo(Route.ONBOARDING1) { inclusive = true }
                        }
                        Log.d(TAG, "Navigation to LOGIN triggered")
                    }
            ...
            Row {
                IconButton(
                    onClick = {
                        Log.d(TAG, "Forward arrow clicked - Navigating to ONBOARDING2")
                        navController.navigate(Route.ONBOARDING2)
                        Log.d(TAG, "Navigation to ONBOARDING2 triggered")
                    },
